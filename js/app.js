(() => {
    ...
    da.init();
    let catalogIcon = document.querySelector(".catalog_icon");
    let catalogIconParent = document.querySelector(".header__menu_catalog");
    if (catalogIcon) catalogIconParent.addEventListener("click", (function() {
        catalogIcon.classList.toggle("open");
        catalogIcon.parentNode.classList.toggle("open");
        document.documentElement.addEventListener("click", (function(e) {
            let Opens = document.querySelectorAll(".open");
            let target = e.target;
            if (target.classList.contains("main") || target.classList.contains("header__menu_bottom") || target.classList.contains("main__container") || target.parentNode.classList.contains("main__container") || target.parentNode.parentNode.classList.contains("main__container") || target.getAttribute("src")) for (let index = 0; index < Opens.length; index++) {
                const element = Opens[index];
                element.classList.remove("open");
            }
        }));
    }));
    let products = document.querySelector(".products_all_body");
    let product = document.querySelector(".product");
    document.querySelector(".showmore_block");
    let showmore = document.querySelector(".showmore");
    let showmorebtn = document.querySelector(".showmorebtn");
    if (showmorebtn) {
        showmore.style.overflow = "hidden";
        showmore.style.height = product.offsetHeight + 10 + "px";
        if (window.screen.width < 500) showmore.style.height = product.offsetHeight + product.offsetHeight + 10 + "px";
        showmorebtn.addEventListener("click", (function() {
            showmorebtn.classList.toggle("show");
            showmorebtn.parentNode.classList.toggle("show");
            if (showmorebtn.parentNode.classList.contains("show")) showmore.style.height = products.offsetHeight + 10 + "px";
            if (!showmorebtn.parentNode.classList.contains("show")) showmore.style.height = product.offsetHeight + 10 + "px";
            if (window.screen.width < 500) {
                if (showmorebtn.parentNode.classList.contains("show")) showmore.style.height = products.offsetHeight + "px";
                if (!showmorebtn.parentNode.classList.contains("show")) showmore.style.height = product.offsetHeight + product.offsetHeight + 10 + "px";
            }
        }));
        if (products.children.length < 2) {
            showmorebtn.style.display = "none";
            if (window.screen.width < 500) showmore.style.height = product.offsetHeight + "px";
        }
        if (2 == products.children.length) {
            showmorebtn.style.display = "none";
            if (window.screen.width < 500) showmore.style.height = product.offsetHeight + product.offsetHeight + "px";
        }
        if (3 == products.children.length) {
            showmorebtn.style.display = "none";
            if (window.screen.width < 500) {
                showmorebtn.style.display = "flex";
                showmore.style.height = product.offsetHeight + product.offsetHeight + 10 + "px";
            }
        }
        if (4 == products.children.length) {
            showmorebtn.style.display = "none";
            if (window.screen.width < 1e3) {
                showmorebtn.style.display = "flex";
                showmore.style.height = product.offsetHeight + "px";
            }
    ...
    let grid = document.querySelector(".articles_grid");
    if (grid) {
        let gridChildrens = grid.children;
        if (10 == gridChildrens.length) {
            gridChildrens[0].style.gridRow = "1/3";
            gridChildrens[0].style.gridColumn = "1/3";
            gridChildrens[9].style.gridRow = "3/5";
            gridChildrens[9].style.gridColumn = "3/5";
            if (window.screen.width <= 1100) {
                grid.style.gridTemplateColumns = "1fr 1fr 1fr";
                gridChildrens[9].style.gridRow = "auto";
                gridChildrens[9].style.gridColumn = "auto";
            }
            if (window.screen.width <= 800) grid.style.gridTemplateColumns = "1fr 1fr";
            if (window.screen.width <= 650) {
                grid.style.gridTemplateColumns = "1fr";
                gridChildrens[0].style.gridRow = "auto";
                gridChildrens[0].style.gridColumn = "auto";
            }
        }
        if (9 == gridChildrens.length) {
            gridChildrens[0].style.gridRow = "1/3";
            gridChildrens[0].style.gridColumn = "1/3";
            if (window.screen.width <= 800) grid.style.gridTemplateColumns = "1fr 1fr";
            if (window.screen.width <= 650) {
                grid.style.gridTemplateColumns = "1fr";
                gridChildrens[0].style.gridRow = "1/2";
                gridChildrens[0].style.gridColumn = "1/2";
            }
        }
        if (gridChildrens.length <= 8) {
            gridChildrens[0].style.gridRow = "1/3";
            gridChildrens[0].style.gridColumn = "1/3";
            if (window.screen.width <= 1100) grid.style.gridTemplateColumns = "1fr 1fr 1fr";
            if (window.screen.width <= 800) grid.style.gridTemplateColumns = "1fr 1fr";
            if (window.screen.width <= 650) {
                grid.style.gridTemplateColumns = "1fr";
                gridChildrens[0].style.gridRow = "1/2";
        ...
        if (2 == gridChildrens.length) {
            gridChildrens[0].style.gridRow = "1/2";
            gridChildrens[0].style.gridColumn = "3/5";
            gridChildrens[1].style.gridRow = "1/2";
            gridChildrens[1].style.gridColumn = "1/3";
            if (window.screen.width <= 1100) {
                grid.style.gridTemplateColumns = "1fr 1fr";
                gridChildrens[0].style.gridRow = "1/2";
                gridChildrens[0].style.gridColumn = "1/2";
                gridChildrens[1].style.gridRow = "1/2";
                gridChildrens[1].style.gridColumn = "2/3";
            }
            if (window.screen.width <= 800) grid.style.gridTemplateColumns = "1fr 1fr";
            if (window.screen.width <= 650) {
                grid.style.gridTemplateColumns = "1fr";
                gridChildrens[0].style.gridRow = "1/2";
                gridChildrens[0].style.gridColumn = "1/2";
                gridChildrens[1].style.gridRow = "auto";
                gridChildrens[1].style.gridColumn = "auto";
            }
        }
        if (gridChildrens.length <= 1) {
            gridChildrens[0].style.gridRow = "1/2";
            gridChildrens[0].style.gridColumn = "1/3";
            if (window.screen.width <= 1100) {
                grid.style.gridTemplateColumns = "1fr 1fr";
    ...
    if (productsFilter) {
        filterList.addEventListener("click", (function() {
            productsFilter.classList.remove("products");
            productsFilter.classList.add("products_list");
            filterList.style.border = "1px dotted #4c4c4c";
            filterGrid.style.border = "1px dotted transparent";
        }));
        filterGrid.addEventListener("click", (function() {
            productsFilter.classList.remove("products_list");
            productsFilter.classList.add("products");
            filterList.style.border = "1px dotted transparent";
            filterGrid.style.border = "1px dotted #4c4c4c";
        }));
        if (window.screen.width < 900) {
            productsFilter.classList.remove("products_list");
            productsFilter.classList.add("products");
        }
        if (productsFilter.classList.contains("products_list")) filterList.style.border = "1px dotted #4c4c4c";
    }
    window["FLS"] = false;
    menuInit();
    functions_menuClose();
